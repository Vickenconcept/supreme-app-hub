            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
                ...
                <div class="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
                    ...
                    <div class="relative flex flex-1 flex-col items-stretch sm:flex-none" data-headlessui-state="">
                        <a href="{{ route('login') }}" class="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-8 text-sm focus:outline-none ring-slate-200 text-gray-50 hover:text-gray-300 hover:ring-slate-300 active:bg-slate-100 active:text-gray-50 focus-visible:outline-blue-600 focus-visible:ring-slate-300 animate-fade-in-right" id="headlessui-menu-button-:r4:" aria-haspopup="true" aria-expanded="false" data-headlessui-state="" type="button">
